...
//         which is the position of each character. The current point's vertical
...
{
   // assume orthographic projection with units = screen pixels, position at top left
...
//
// xoff/yoff are the offset it pixel space from the glyph position to the top-left of the bitmap
...
// get the bbox of the bitmap centered around the glyph position; so the
